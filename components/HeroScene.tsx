    ...
    <section ref={sectionRef} className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <AnimatePresence>
        {!isOpen && (
          ...
          >
            <a href="https://github.com/selyan-mhli" target="_blank" rel="noopener noreferrer" className="text-white/30 transition-colors hover:text-sand">
            ...
            <a href="https://www.linkedin.com/in/selyanmouhali/" target="_blank" rel="noopener noreferrer" className="text-white/30 transition-colors hover:text-sand">
