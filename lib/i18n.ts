...
const s: Record<string, Record<Lang, string>> = {
  ...
  about_desc:         { fr: ", étudiant en deuxième année d'école d'ingénieur à l'Université de Technologie de Troyes. Curieux, rigoureux et motivé, j'aime construire des projets numériques, découvrir de nouvelles technologies et apprendre par la pratique.", en: ", a second-year engineering student at the University of Technology of Troyes. Curious, rigorous and motivated, I enjoy building digital projects, discovering new technologies and learning through hands-on experience.", es: ", estudiante de segundo año de ingeniería en la Universidad de Tecnología de Troyes. Curioso, riguroso y motivado, disfruto creando proyectos digitales, descubriendo nuevas tecnologías y aprendiendo de forma práctica.", ko: ", 트루아 공과대학교 2학년 공학도입니다. 호기심, 꼼꼼함, 열정을 갖고 디지털 프로젝트를 만들고, 새로운 기술을 탐구하며, 실습을 통해 배우는 것을 즐깁니다." },
  ...
  edu_mariepila_title:   { fr: "Baccalauréat section européenne, mention très bien — Marie Pila", en: "French Baccalaureate, European Section, Highest Honors — Marie Pila", es: "Bachillerato, sección europea, mención sobresaliente — Marie Pila", ko: "유럽반 바칼로레아 최우수 졸업 — Marie Pila" },
  edu_mariepila_period:  { fr: "2024 · Avignon, France", en: "2024 · Avignon, France", es: "2024 · Avignon, Francia", ko: "2024 · 아비뇽, 프랑스" },
  edu_mariepila_desc:    { fr: "Spécialités Mathématiques, Mathématiques Expertes, Physique-Chimie et SES (Sciences économiques et sociales). Option latin jusqu'au brevet.", en: "Specialties: Mathematics, Advanced Mathematics, Physics-Chemistry, and Economic and Social Sciences. Latin option through middle school certificate.", es: "Especialidades: Matemáticas, Matemáticas Avanzadas, Física-Química y Ciencias Económicas y Sociales. Opción de latín hasta el brevet.", ko: "전공: 수학, 심화 수학, 물리-화학, 경제·사회 과학. 라틴어는 브레베까지 선택 과목이었습니다." },
  ...
  edu_reynolds_desc:     { fr: "Un mois d'échange international. Immersion anglophone complète, cours du système canadien et découverte culturelle.", en: "One-month international exchange. Full English immersion, Canadian curriculum classes and cultural discovery.", es: "Un mes de intercambio internacional. Inmersión completa en inglés, clases del sistema canadiense y descubrimiento cultural.", ko: "한 달간의 국제 교환. 영어 완전 몰입, 캐나다 교육과정 수업 및 문화 체험." },
