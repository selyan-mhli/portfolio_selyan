...
const s: Record<string, Record<Lang, string>> = {
  ...
  passion_karate_d:   { fr: "Ceinture noire — pratiquant depuis 10 ans. Discipline, concentration et persévérance.", en: "Black Belt — practicing for 10 years. Discipline, focus and perseverance.", es: "Cinturón negro — practicante desde hace 10 años. Disciplina, concentración y perseverancia.", ko: "블랙벨트 — 10년간 수련. 규율, 집중, 인내." },
  ...
  passion_cooking:    { fr: "Cuisine", en: "Cooking", es: "Cocina", ko: "요리" },
  passion_cooking_d:  { fr: "Explorer les saveurs et la créativité à travers la cuisine.", en: "Exploring flavors and creativity through cooking.", es: "Explorar sabores y creatividad a través de la cocina.", ko: "요리를 통해 맛과 창의력을 탐구하다." },
  passion_reading:    { fr: "Lecture", en: "Reading", es: "Lectura", ko: "독서" },
  passion_reading_d:  { fr: "Enrichir ses connaissances et son imagination par les livres.", en: "Expanding knowledge and imagination through books.", es: "Ampliar conocimientos e imaginación a través de los libros.", ko: "책을 통해 지식과 상상력을 넓히다." },
